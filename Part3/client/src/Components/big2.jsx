...
export default (props) => {
    ...
    return(
            ...
            <div className='bigCard2' style={props.row == null ? {backgroundImage: `url(${backupImage})`} : {backgroundImage: `url(${props.row.mediaurl}), url(${backupImage})`}} onMouseEnter={()=>setHidden(false)} onMouseLeave={()=>setHidden(true) }>
