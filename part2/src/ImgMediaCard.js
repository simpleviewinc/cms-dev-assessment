...
export class ImgAndFallback extends React.Component{
    ...
    render(){
        return <img onError={erEv => erEv.target.src="https://material-ui.com/static/images/cards/contemplative-reptile.jpg"} src={this.props.mediaurl}></img>
    }
}
    ...
    render(){
        return(
            <React.Fragment>
                ...
                <p className="post-body2">{this.props.description}</p>  
            </React.Fragment>
        );
    }
}
